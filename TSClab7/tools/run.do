...
# Load project
  eval vsim -novopt -quiet -nocoverage +notimingchecks +nowarnTSCALE -sva  -g/top/test/NUMBEROFTRANSACTIONS=$1 -g/top/test/RANDOMCASE=$2 -g/top/test/SEED=$3 -g/top/test/TESTNAME=$4 top
# eval vsim -novopt -quiet -coverage +code=bcesft +notimingchecks +nowarnTSCALE -sva top

# Run log/wave commands
# Batch_mode = 0 [GUI_mode]; Batch_mode = 1 [regress_mode/command_line]
if {[batch_mode] == 0} {
  eval log -r /*
  eval do wave.do
}
